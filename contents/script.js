        ...
        function game_execute() {
            ...
            let situations = [
                ...
                "The CEO of battery manufacturing company claims that an average battery lasts 3 days" + standard_deviation_text + distribution_text +". If the CEO's claim were true, what is the probability that " + sample_space + " randomly selected batteries would have an average life of no more than 2.5 days?",
